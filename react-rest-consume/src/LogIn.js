...
class LogIn extends Component {
    ...
    getUserPropertyAssignments = event => {
        ...
        requestHeaders.append("Access-Control-Allow-Headers", "Access-Control-Allow-Headers, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers");
    ...
    clickOnLogOut = event => {
        ...
        //requestHeaders.append('Origin','https://dev.building.chat/api/login/');
        fetch('https://dev.building.chat/api/logout/', {
            method: 'GET',
            headers: requestHeaders
        })
            .then(
                ...
                return (
                    <div className="container" align="center">
                        <div className="float-right">
                            <button type="submit" className="btn form-control-buttom center-block"
                                    onClick={this.clickOnLogOut}>LogOut
                            </button>
                        </div>
